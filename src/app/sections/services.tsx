      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            <Card key={index} className="flex flex-col items-center text-center p-8 bg-card border-2 border-transparent hover:border-primary/50 hover:bg-muted/50 transition-all duration-300 transform hover:-translate-y-2">
