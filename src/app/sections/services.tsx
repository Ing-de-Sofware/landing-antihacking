    ...
    <section id="services" className="bg-card py-20 lg:py-32">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        <div className="text-center mb-12">
          <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm font-medium text-primary mb-4">Servicios</div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            <Card key={index} className="flex flex-col items-center text-center p-8 bg-card border-2 border-transparent hover:border-primary/50 hover:bg-muted/30 transition-all duration-300 transform hover:-translate-y-2">
