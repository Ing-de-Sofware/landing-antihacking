  ...
  return (
    <section id="hero" className="container mx-auto flex min-h-[calc(100vh-5rem)] max-w-7xl flex-col items-center justify-center gap-10 px-4 py-20 text-center md:px-6 section-animate">
      ...
      <div className="max-w-4xl space-y-6">
        <h1 className="text-4xl font-headline font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-foreground/90 to-foreground/60">
          Descubre tus vulnerabilidades <span className="text-primary">antes</span> que los atacantes
        </h1>
        <p className="mt-6 text-lg text-muted-foreground md:text-xl">
          En PentGuin, ofrecemos evaluaciones de seguridad de élite para proteger tus activos digitales más críticos. Anticípate a las amenazas con nuestro equipo de expertos.
        </p>
      </div>
