...
export default function Contact() {
  return (
    <section id="contact" className="py-20 lg:py-32 bg-card border-t">
      <div className="container mx-auto max-w-3xl px-4 md:px-6">
        <div className="text-center mb-12">
          <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm font-medium text-primary mb-4">Contacto</div>
